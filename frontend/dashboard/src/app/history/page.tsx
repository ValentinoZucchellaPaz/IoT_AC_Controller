...
export default function HistoryPage() {
  ...
  return (
    <div className="min-h-[100dvh] overflow-x-hidden text-white antialiased bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-10 pb-24">
        ...
        <section className="animate-fade-in">
          ...
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              {loading && (
                <i className="ph ph-spinner-gap animate-spin text-xl text-blue-400" />
              )}
            </div>
          </div>
          {noData ? (
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-5 shadow-lg text-center">
              ...
              <p className="mt-2 text-zinc-400">
                No se encontraron mediciones para el período seleccionado.
              </p>
            </div>
          ) : (
