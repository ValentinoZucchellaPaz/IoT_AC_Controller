...
import app.observer.ThresholdAlertService;
...
public class Main {
    public static void main(String[] args) {
        ...
        TransportObserver currObserver = new AlertObserver(new ThresholdAlertService(15,62), Logger.getInstance());
        ...
        while(running){
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    currObserver = new AlertObserver(new ThresholdAlertService(100, 46), Logger.getInstance());
                    monitor.subscribe(currObserver);
                    break;
                case 3:
                    ...
                    monitor.unsubscribe(currObserver);
                    currObserver = new AlertObserver(new ThresholdAlertService(15000, 33), Logger.getInstance());
                    monitor.subscribe(currObserver);
                    break;
                case 4:
                    ...
                    monitor.setStrategy(new BikeStrategy());
                    monitor.unsubscribe(currObserver);
                    currObserver = new AlertObserver(new ThresholdAlertService(15, 62), Logger.getInstance());
                    monitor.subscribe(currObserver);
                    break;
                case 5:
